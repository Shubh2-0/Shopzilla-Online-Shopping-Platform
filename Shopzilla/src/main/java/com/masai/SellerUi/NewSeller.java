...
public class NewSeller extends JFrame {
	...
	public NewSeller() {
		...
		lblNewLabel_7 = new JLabel("Welcome To Shopzilla");
		...
		lblNewLabel_6_1.setBounds(174, 552, 95, 45);
		...
		lblNewLabel_6_1_1.setBounds(271, 559, 66, 30);
		panel.add(lblNewLabel_6_1_1);
		
		lblNewLabel_6_1_2 = new JLabel("₹");
		lblNewLabel_6_1_2.setForeground(Color.PINK);
		lblNewLabel_6_1_2.setFont(new Font("Bahnschrift", Font.BOLD, 23));
