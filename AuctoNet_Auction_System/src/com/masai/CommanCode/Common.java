...
public class Common {
	...
	public static String nameFormat(String name) {
     ...
     public static boolean checkPasswordLength(String password) {
    	 ...
    	 else if(password.length() > 12) return true;
     ...
     public static boolean checkPhoneNumber(String phone) {
    	 ...
    	 for(int i=0;i<phone.length();i++) {
    		 ...
    		 if(small.indexOf(el) != -1 || upper.indexOf(el) != -1) return true;
    		 
    		 if(num.indexOf(phone.charAt(i)) != -1 ) c++;
    		 
    		 
    	 }
    	 
    	 if(c!=phone.length()) return true; 
     ...
     public static boolean checkBalance(String balance) {
    	 ...
    	 for(int i=0;i<balance.length();i++) {
    		 ...
    		 if(num.indexOf(balance.charAt(i)) != -1 ) c++;
    		 
    	 }
    	 
    	 if(c!=balance.length()) return true;
