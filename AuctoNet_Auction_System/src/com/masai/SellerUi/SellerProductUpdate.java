		...
		btnUpdateProduct.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if(amount <= 10 || amount > 2000000) {
                	...
                	JOptionPane.showMessageDialog(null, "Please ensure that the price is greater than 10 rupees and less than 2,000,000 rupees");
					textField_1.setText(product.getProductPrice()+"");
					return;
                }
                ...
                if(productDao.updateProductBySeller(product, id)) {
                	...
                	JOptionPane.showMessageDialog(null, "Product update successful. Note that any empty fields will retain their previous values");
                ...
                else
                {
                	...
                	JOptionPane.showMessageDialog(null, "Something went wrong try to uypdate product some times letter");
                	frame.setVisible(false);
					SellerViewProducts.main(null);
