		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(Common.checkPasswordLength(password)) {
					...
					JOptionPane.showMessageDialog(null, "Your password should be between 7 and 12 characters in length to meet the security requirements");
					return ;
				...
				if(Common.checkPasswordHaveSpace(password)) {
					...
					JOptionPane.showMessageDialog(null, "Keep your password free from more than 4 spaces, as it is recommended for better password security");
					return ;
	               ...
	               if(Common.checkPhoneNumber(mobileNo)) {
					...
					JOptionPane.showMessageDialog(null, "Phone numbers should only contain numeric digits. Avoid using alphabetic or special characters");
					return ;
