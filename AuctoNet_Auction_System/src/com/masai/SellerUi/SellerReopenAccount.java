			...
			public void actionPerformed(ActionEvent e) {
				...
				if(username.equals("") || password.equals("") || confirmPassword.equals("")) {
					...
					if(sellerDao.reopenSeller(username, password)) {
						...
						JOptionPane.showMessageDialog(null, "We are delighted to inform you that your account has been successfully reopened.\n"
						...
						JOptionPane.showMessageDialog(null, "We apologize, but no seller account matching the provided username and password was found for reopening.\n"
