		...
		try {
			...
			if (quantity != 0) {
				...
				String INSERT_QUERY = "  INSERT INTO transactions (" + "      product_id," + "      product_name,"
						+ "      buyer_id," + "      buyer_name," + "      quantity," + "      purchase_date,"
						+ "      amount_per_piece," + "      price, " + "      gst_percentage," + "      tax_amount,"
						+ "      total_price," + "      return_policy) values(" + "      ?,"
